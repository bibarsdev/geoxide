...
namespace Geoxide {
	...
	{
	public:
		MouseMovedEvent(uint32_t x, uint32_t y, uint32_t xRel, uint32_t yRel, MouseButton button) :
			MovedEvent(kEventMouseMoved, x, y), mXRel(xRel), mYRel(yRel), mButton(button){}
